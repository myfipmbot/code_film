...
module.exports = {
  BOTNAME: "𝙆𝘼𝙑𝙄 𝙀𝙓𝙀 𝙈𝙊𝙑𝙄𝙀 𝘿𝙇🎬",
  OWNERNAME: "MR.KAVISHKA",
  OWNERNUMBER: "94760383959",
  FOOTER: `
> 𝙆𝘼𝙑𝙄 𝙀𝙓𝙀 𝙈𝙊𝙑𝙄𝙀 𝘿𝙇 🎬.
    `.trim(),
  //====================menu=================================
...
┏━━━━❮📝 ᴅᴇᴛᴇʟᴇꜱ 📝❯━━━
┃🗣️ 𝚄𝚜𝚎𝚛 : ${pushname}
┃🤖 𝙱𝚘𝚝 : 𝙺𝙰𝚅𝙸 𝙴𝚇𝙴 𝙼𝙾𝚅𝙸𝙴 𝙳𝙻🎬 V${packageJson.version}
